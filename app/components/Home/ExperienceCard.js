  ...
  return (
    <section>
      <div className="px-[200px] w-full grid grid-cols-3 gap-x-28 my-[90px]">
        <div className="w-[310px] h-[183px] flex justify-center items-center bg-[#d0d0f7]">
          <div>
            <h1 className="text-[60px] font-bold"> 10+</h1>
            <span> Years Experience</span>
          </div>
        </div>
        <div className="w-[310px] h-[183px] bg-[#f8efe6] flex justify-center items-center">
          <div>
            <h1 className="text-[60px] font-bold"> 100+</h1>
            <span className="text-center"> Client Handle</span>
          </div>
        </div>
        <div className="w-[310px] h-[183px] bg-[#c3fafd] flex justify-center items-center">
          <div>
